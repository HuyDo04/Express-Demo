...
async function run() {
  try {
    ...
    for (let i = 0; i < records; i++) {
      ...
      // Random gender - lowercase to match enum
      ...
      // Generate intro (60% chance of having an intro)
      const intro =
        Math.random() > 0.4 ? faker.lorem.paragraphs({ min: 1, max: 3 }) : null;

      // Random is_active status (95% chance of being active)
